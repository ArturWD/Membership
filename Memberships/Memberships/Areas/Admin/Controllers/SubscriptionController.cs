...
namespace Memberships.Areas.Admin.Controllers
{
    public class SubscriptionController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,Title,Sescription,RegistrationCode")] Subscription subscription)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,Title,Sescription,RegistrationCode")] Subscription subscription)
        {
            if (ModelState.IsValid)
            {
